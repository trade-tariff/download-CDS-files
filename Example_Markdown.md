...
```python
md_file.new_header(level=1, title='Setext Header 1', style='setext')
md_file.new_header(level=2, title='Setext Header 2', style='setext')
```
Setext Header 1
===============
...
```python
md_file.new_paragraph("This is an example of text in which has been added color, bold and italics text.", bold_italics_code='bi', color='purple')
```
...
```python
md_file.new_line("This is an inline code which contains bold and italics text and it is centered", bold_italics_code='cib', align='center')
```  
...
```python
md_file.write("The following text has been written with ``write`` method. You can use markdown directives to write:"
...
```python
md_file.new_line('  - Inline link: ' + md_file.new_inline_link(link='https://github.com/didix21/mdutils', text='mdutils')) 
md_file.new_line('  - Bold inline link: ' + md_file.new_inline_link(link='https://github.com/didix21/mdutils', text='mdutils', bold_italics_code='b') 
md_file.new_line('  - Italics inline link: ' + md_file.new_inline_link(link='https://github.com/didix21/mdutils', text='mdutils', bold_italics_code='i') 
md_file.new_line('  - Code inline link: ' + md_file.new_inline_link(link='https://github.com/didix21/mdutils', text='mdutils', bold_italics_code='i') 
md_file.new_line('  - Bold italics code inline link: ' + md_file.new_inline_link(link='https://github.com/didix21/mdutils', text='mdutils', bold_italics_code='cbi') 
md_file.new_line('  - Another inline link: ' + md_file.new_inline_link(link='https://github.com/didix21/mdutils') 
...
md_file.write('\n  - Reference link: ' + md_file.new_reference_link(link='https://github.com/didix21/mdutils', text='another reference', reference_tag='md')
md_file.write('\n  - Bold link: ' + md_file.new_reference_link(link='https://github.com/didix21/mdutils', text='Bold reference', reference_tag='bold', bold_italics_code='b')
md_file.write('\n  - Italics link: ' + md_file.new_reference_link(link='https://github.com/didix21/mdutils', text='Bold reference', reference_tag='italics', bold_italics_code='i')
...
You can add ordered ones easily, too: ``md_file.new_list(items, marked_with='1')``
1. Item 1
2. Item 2
3. Item 3
4. Item 4
...
Maybe you want to replace the default hyphen ``-`` by a ``+`` or ``*`` then you can do: ``md_file.new_list(items, marked_with='*')``.
## Add images
...
With ``Html.image`` you can change size of images in a markdown file. For example you can dothe following for changing width: ``md_file.new_paragraph(Html.image(path=path, size='200'))``
...
Or change width and height: ``md_file.new_paragraph(Html.image(path=path, size='300x300'))``
...
Html.image allow to align images, too. For example you can run: ``md_file.new_paragraph(Html.image(path=path, size='300x200', align='center'))``
