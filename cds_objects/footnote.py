...
class Footnote(Master):
    ...
    def write_data(self):
        ...
        self.worksheet.write(
            self.row_count, 0, self.operation_text + " footnote", g.excel.format_wrap
        )
        self.worksheet.write(
            self.row_count,
            1,
        ...
        self.worksheet.write(
            self.row_count, 2, self.footnote_type_id, g.excel.format_wrap
        )
        ...
        self.worksheet.write(
            self.row_count, 6, self.description_string, g.excel.format_wrap
        )
