...
from cds_objects.measure_excluded_geographical_area import (
...
class Measure(Master):
    ...
    def get_measure_components(self):
        ...
        self.duty_expression_array = ["Duty expression", self.combined_duty]
    ...
    def get_measure_excluded_geographical_areas(self):
        ...
        if measure_excluded_geographical_areas:
            ...
            ) in measure_excluded_geographical_areas:
        ...
        self.exclusion_string_array = ["Excluded countries", self.exclusion_string]
    ...
    def get_footnotes(self):
        ...
        self.footnote_array = ["Associated footnotes", self.footnote_string]
