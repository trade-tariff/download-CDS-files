...
class GeographicalAreaDescription(Master):
    ...
    def get_data(self):
        ...
        self.description = Master.process_null(self.elem.find("geographicalAreaDescription/description"))
        self.tbl = [
               "Description start date", Master.format_date(self.validity_start_date),
               "Description", self.description,
               ]
        self.description_string = Master.format_date(self.validity_start_date) + " : " + self.description + "\n"
