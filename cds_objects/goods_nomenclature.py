...
class GoodsNomenclature(Master):
    ...
    def get_data(self):
        ...
        self.goods_nomenclature_item_id = Master.process_null(
            self.elem.find("goodsNomenclatureItemId")
        )
        self.product_line_suffix = Master.process_null(
            self.elem.find("produclineSuffix")
        )
        self.statistical_indicator = Master.process_null(
            self.elem.find("statisticalIndicator")
        )
